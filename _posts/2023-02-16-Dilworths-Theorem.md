...
사슬 분할이란 부분순서 집합 $S$을 모든 원소가 각각 하나의 사슬에 포함되도록 여러 개의 사슬로 분할하는 것입니다. 이 때 사슬 개수의 최솟값이 반사슬의 최대 크기와 같다는 것이 딜워스의 정리입니다.
...
사실 이렇게 DAG를 이분그래프로 바꿔서 최대매칭을 통해 사슬분할의 개수를 구하는 기법은 부분 순서 집합뿐만 아니라 일반적인 DAG에서도 최소 경로분할을 구하는 데 이용할 수 있습니다. 예시 문항으로는 [BOJ 1671](https://www.acmicpc.net/problem/1671) 등이 있습니다.
