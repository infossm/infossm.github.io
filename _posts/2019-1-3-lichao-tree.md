...
LiChao Tree는 Dynamic Segment Tree에 기반한 자료구조입니다. Dynamic Segment Tree란 기존의 구간 범위를 결정해놓고 시작하는 일반적인 Segment Tree와 다르게 쿼리가 들어올 때마다 그때그때 필요한 노드를 생성해나가는 Segment Tree 입니다.
...
여기서 $$ [3,8] $$ 구간에 1을 더하는 연산을 수행하려면 어떻게 해야 할까요? 필요한 노드들을 생성해서 자식으로 붙여 주면 됩니다. 아래 그림과 같이 트리가 확장될 것입니다.

[그림]

이후에 $$ [5,6] $$ 구간에 1을 더하는 연산이 들어오면 아래 그림과 같이 트리가 확장될 것입니다.
...
전체 합쳐진 코드는 [링크](https://www.acmicpc.net/source/share/24f0ef4c5176427b85fb95eaa1a75897) 에서 확인하세요.
