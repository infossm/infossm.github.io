...
$$ \pi_\theta(a|x) $$ 를 $$\theta $$ 를 매개변수로 사용하는 policy $$ \pi $$ 를 따를 경우 현재 상태가 $$ x $$일 때 행동 a를 취할 확률로 정의했을 때, Policy Gradient Theorem에 따르면 성능을 올리기 위해선
