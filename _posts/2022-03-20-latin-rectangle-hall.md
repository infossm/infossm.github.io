...
![5×5 라틴 방진](/assets/images/latin-rectangle-hall/latin-01.png){: width="50"}
...
행을 확장할 때에는 최대 이분 매칭 알고리즘을 이용하면 항상 완벽 이분 매칭을 찾을 수 있으므로, 쿤의 알고리즘 (Kuhn's Algorithm)이나 호프크로프트-카프 알고리즘 (Hopcroft–Karp Algorithm) 등 최대 이분 매칭 알고리즘을 반복하면 $n\times n$ 라틴 방진을 복구하는 것이 가능합니다.
