...
<p align="center">
$E[D^p {D^{\ast}}^q] = \begin{cases}{2\over3} {1\over {2^{p+q}-1}} \sum_{i=0}^p \sum_{j=0}^q d_{p,q}(i,j) \times {_pC_i} {_qC_j} E[D^i {D^{\ast}}^j] & ( 6 \mid p-q ) \\ \phantom{11111111111111111111}0 & \text{otherwise} \end{cases}$
</p>
...
<p align="center">
$E[|D|] =  {1\over 3} (E[ {|0 + {1\over2}D}| ]) +  {2\over 3} (E[ {|{1\over2} + {1\over2}D}| ]) \\ E[|D|] = {2 \over 5}E[|1 + D|] \\ E[|1+D|] =  \sum_{x_i\in X, \ x_i \neq -1} p(x=x_i)(E[|1+{1\over2}x_i + {1\over2}D]) + {1\over9}(E[1-{1\over2}+{1\over2}D]) \\ E[|1+D|] = {18 \over 17} \sum_{x_i\in X, \ x_i \neq -1} p(x=x_i)(E[|1+{1\over2}x_i + {1\over2}D]) \\ E[|D|] = {36 \over 85} \sum_{x_i\in X, \ x_i \neq -1} p(x=x_i)(E[|1+{1\over2}x_i + {1\over2}D])$
</p>
