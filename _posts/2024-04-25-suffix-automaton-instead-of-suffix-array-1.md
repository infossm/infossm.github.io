...
Suffix Automaton은 **하나의 노드에 여러 개의 문자열이 대응**될 수 있게 함으로써 $O(\vert S\vert )$개의 노드만으로 Suffix Trie의 기능을 유지하는 자료구조입니다. 또한, Suffix Automaton을 구성하는 과정에서 Suffix Link 등의 유용한 추가 정보도 얻을 수 있습니다. 다음은 위와 동일하게 $S=\rm{abcbc}$로 Suffix Automaton을 만든 결과입니다. 
...
### [[연습 문제] 서로 다른 부분 문자열의 개수 2 (BOJ 11479)](https://www.acmicpc.net/problem/11479)
...
### [[연습 문제] 서로 다른 부분 문자열 쿼리 2 (BOJ 16907)](https://www.acmicpc.net/problem/16907) 
...
### [[연습 문제] May I Add a Letter? (BOJ 22276)](https://www.acmicpc.net/problem/22276)
