...
예를 들어 집합 $S=\left\{(1,1),(2,3),(3,2),(4,4)\right\}$를 생각하고  $x_1\leq x_2,y_1\leq y_2$이면 $(x_1,y_1)\leq(x_2,y_2)$로 정의합시다. 여기서 사슬 분할을 $\left\{(1,1),(2,3)\right\},\left\{(3,2),(4,4)\right\}$와 같이 할 수 있고 이것보다 적은 개수로 분할할 수는 없습니다. 그리고 반사슬은 $\left\{(1,1)\right\},\left\{(2,3),(3,2)\right\}$등이 있고 반사슬의 최대 크기는 2로 사슬분할의 최솟값과 같다는 것을 알 수 있습니다.
...
$N$개의 인형이 있으며 각 인형은 $w_i$의 너비와 $h_i$의 높이를 가집니다. $w_i\leq w_j,h_i\leq h_j$이면 $i$번 인형을 $j$번 인형 안에 넣을 수 있습니다. 이 때 인형들을 다른 인형 안에 넣어 최소 개수의 인형만 남게 하는 것이 문제입니다.
